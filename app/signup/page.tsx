    ...
    <span>EXQUISITE</span>
        ...
        <div className="relative flex-1 my-6 rounded-xl overflow-hidden border border-white/10">
          <Image 
            ...
            alt="Fashion designer packaging custom garments" 
            fill 
            priority 
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-white z-10">
        <form onSubmit={handleSubmit} className="w-full max-w-md">
          ...
          <button 
            type="submit"
            className="w-full rounded-lg bg-indigo text-ivory py-3 font-medium hover:bg-indigo-dark transition-colors"
          >
            Sign up
          </button>
          <p className="text-sm text-ink/60 mt-4 text-center">
            Already have an account? <a href="/login" className="text-indigo hover:underline">Log in</a>
          </p>
        </form>
      </div>
    </div>
